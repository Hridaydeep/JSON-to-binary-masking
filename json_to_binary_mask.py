# -*- coding: utf-8 -*-
"""JSON to binary mask.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bQ1mBrzg665aXv6ZVh5aNFFciX3rEM1g
"""
...
def add_to_dict(data, itr, key, count):
  try:
    ...
    print(data[itr]["regions"][count]["shape_attributes"]["all_points_x"])
    y_points = data[itr]["regions"][count]["shape_attributes"]["all_points_y"]
    print(data[itr]["regions"][count]["shape_attributes"]["all_points_y"])
  except:
...
for file_name in os.listdir(source_folder):
    # Create a new folder based on the file name (excluding the extension)
    to_save_folder = os.path.join(source_folder, file_name[:-4])

    # Print the file name without the extension (for verification)
    print(file_name[:-4])

    # Create subfolders "images" and "masks" inside the new folder
    image_folder = os.path.join(to_save_folder, "images")
    mask_folder = os.path.join(to_save_folder, "masks")

    # Create the new folder and its subfolders (if they don't exist)
    ...
    # Move the image to the "images" subfolder of the new folder
